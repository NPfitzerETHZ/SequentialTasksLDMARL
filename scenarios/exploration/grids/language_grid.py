...
from scenarios.exploration.grids.internal_grids import InternalOccupancyGrid
from scenarios.exploration.grids.environment_grids import EnvironmentGrid
    ...
    def spawn_llm_map(
        ...
        if use_embedding: # Case we sample the dataset for the new scenario + Embedding
            ...
            if train_dict is not None and total_dict_size is not None:
                self.sample_dataset(env_index, packet_size, forced_state=None)
